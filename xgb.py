...
print("\n------ PATIENT REPORT ------")
print("Health Status:", status_map[pred_label])
print("Health Score:", f"{score_map[pred_label]}/100")
print("Recommendation:", recommendation_map[pred_label])